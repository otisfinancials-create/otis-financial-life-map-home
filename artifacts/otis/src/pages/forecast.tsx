...
export default function Forecast() {
  ...
  // Build running balance starting from $0 for the current month view
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Projected income and expenses based on your bills and pay schedule.
          </p>
        </div>
        <div className="flex items-center gap-2">
          ...
          >
            <RefreshCw
              className={`mr-2 h-4 w-4 ${regenerateForecast.isPending || isAutoGenerating ? "animate-spin" : ""}`}
            />
            Regenerate
          </Button>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between bg-card p-2 rounded-lg border border-border">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button variant="ghost" size="sm" onClick={today} className="text-xs h-7">
                Today
              </Button>
            </div>
            ...
            <Card className="bg-card border-border py-4 px-6 flex flex-col justify-center">
              ...
              <span
                className={`text-xl font-mono font-medium ${
                  currentMonthTotals.income - currentMonthTotals.expenses >= 0
                    ? "text-foreground"
                    : "text-destructive"
                }`}
              >
                <FormatCurrency
                  amount={currentMonthTotals.income - currentMonthTotals.expenses}
                  showSign
                />
              </span>
            </Card>
            ...
            {isLoadingTransactions ? (
              ...
              <div className="p-12 text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Projecting transactions from your bills and pay schedule...
                </p>
              </div>
                  ...
                  {transactionsWithBalance.map((t) => (
                    <TableRow key={t.id} className="border-border">
                      <TableCell className="font-mono text-xs text-muted-foreground">
                        {format(new Date(t.transactionDate + "T00:00:00"), "MMM dd")}
                      </TableCell>
                      <TableCell className="font-medium">
                        ...
                        {t.isActual && (
                          <Badge
                            variant="secondary"
                            className="ml-2 text-[10px] px-1 h-4 bg-primary/20 text-primary"
                          >
                            Cleared
                          </Badge>
                        )}
                      ...
                      <TableCell className="text-right font-mono">
                        <span
                          className={
                            t.transactionType === "income" ? "text-chart-2" : "text-foreground"
                          }
                        >
                      ...
                      <TableCell className="text-right font-mono">
                        ...
                        >
                          <FormatCurrency amount={t.runningBalance} showSign={t.runningBalance < 0} />
                        </span>
                      </TableCell>
                    </TableRow>
                  ))}
              ...
              <div className="p-12 text-center text-muted-foreground">
                ...
                <p className="text-sm mt-1">
                  Make sure you have active bills and a pay schedule configured.
                </p>
              </div>
            )}
          </Card>
